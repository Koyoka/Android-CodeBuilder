...
//
//public class V1_CommonGetInputDtoTemplate extends IScriptTemplate {
//
//	@Override
...
//line(sb);
//appendLine(sb,"import com.eleven.httpvolleypromiser.proxy.base.BaseHttpGetModelDto;");
//line(sb);
//appendLine(sb,"public class " + StringHelper.upperCaseFirst(clsStruct.getClassName()) + " extends BaseHttpGetModelDto{");
//line(sb);
...
//
//appendLine(sb,"	@Override");
//appendLine(sb,"	public String getQueryStr(String url){");
//line(sb);
//appendLine(sb,"		String qStr = url  ");
//for(ClassFieldInfo item : clsStruct.getFieldList()){
//	appendLine(sb,"		.replaceFirst(\"\\\\{"+item.getFieldName()+"\\\\}\", this."+item.getFieldName()+"==null?\"\":this."+item.getFieldName()+")");
//}
//appendLine(sb,"			;");
//appendLine(sb,"		return qStr;");
//appendLine(sb,"	}");
//line(sb);
//appendLine(sb,"}");
//
